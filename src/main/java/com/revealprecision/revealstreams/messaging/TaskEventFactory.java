package com.revealprecision.revealstreams.messaging;


import com.revealprecision.revealstreams.messaging.message.LookupInterventionTypeEvent;
import com.revealprecision.revealstreams.persistence.domain.Goal;
import com.revealprecision.revealstreams.persistence.domain.Location;
import com.revealprecision.revealstreams.persistence.domain.LookupTaskStatus;
import com.revealprecision.revealstreams.persistence.domain.Task;
import com.revealprecision.revealstreams.factory.LookupEntityTypeEventFactory;
import java.util.ArrayList;
import java.util.List;
import java.util.UUID;
import java.util.stream.Collectors;
import com.revealprecision.revealstreams.messaging.message.ActionEvent;
import com.revealprecision.revealstreams.messaging.message.GoalEvent;
import com.revealprecision.revealstreams.messaging.message.LocationHierarchyEvent;
import com.revealprecision.revealstreams.messaging.message.LookupTaskStatusEvent;
import com.revealprecision.revealstreams.messaging.message.PlanEvent;
import com.revealprecision.revealstreams.messaging.message.PlanTargetTypeEvent;
...
import com.revealprecision.revealstreams.persistence.domain.LookupInterventionType;
