...
public enum ApplicableReportsEnum {
  ...
  MDA(List.of(ReportTypeEnum.MDA_FULL_COVERAGE.name(),ReportTypeEnum.ONCHOCERCIASIS_SURVEY.name())),
  IRS_LITE(List.of(ReportTypeEnum.IRS_LITE_COVERAGE.name(),
      ReportTypeEnum.IRS_LITE_COVERAGE_OPERATIONAL_AREA_LEVEL.name(),ReportTypeEnum.MDA_FULL_COVERAGE_OPERATIONAL_AREA_LEVEL.name())),
